...
- Phisics collition methods do the loop and return the object (or null) instead of true or false
- Enhanced Animation class to accept any number of images using ArrayList<BufferedImage> structure.
